...
export default function Groups() {
  ...
  const fetchGroups = async () => {
    try {
      ...
      const groupsData = res?.data?.groups || res?.groups || res || [];
      setGroups(Array.isArray(groupsData) ? groupsData : []);
    } catch (error) {
      // Using toast for user feedback instead of just console.error
  ...
  const handleQRSuccess = (group) => {
    ...
    // Optionally navigate to the group chat after successful scan
              ...
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center h-full p-8 text-center">
                  ...
                  <p className="text-sm text-gray-400 mt-2">
                    {searchQuery
                      ? "No results found"
                      : "Start a conversation by accepting a job application"}
                  </p>
                </div>
              ) : (
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="relative flex-shrink-0">
                          ...
                          {group.lastMessageAt &&
                            new Date() - new Date(group.lastMessageAt) <
                              3600000 && (
