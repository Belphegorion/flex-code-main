...
const seedDatabase = async () => {
  try {
    ...
    const jobs = await Job.insertMany([
      ...
      { title: 'Stage Crew & Setup', description: 'Stage setup and equipment', eventId: events[1]._id, organizerId: organizers[1]._id, roles: ['Stage Crew'], requiredSkills: ['Technical Support', 'Physical Fitness'], dateStart: new Date('2024-06-20T06:00:00'), dateEnd: new Date('2024-06-22T23:00:00'), location: { city: 'New York', state: 'NY' }, payPerPerson: 30, totalPositions: 15, positionsFilled: 12, status: 'open' },
      ...
      { title: 'Booth Attendants', description: 'Manage expo booths', eventId: events[3]._id, organizerId: organizers[3]._id, roles: ['Customer Service'], requiredSkills: ['Communication', 'Sales'], dateStart: new Date('2024-05-05T09:00:00'), dateEnd: new Date('2024-05-07T18:00:00'), location: { city: 'Brooklyn', state: 'NY' }, payPerPerson: 24, totalPositions: 25, positionsFilled: 20, status: 'open' },
      ...
      { title: 'Gallery Guides', description: 'Art exhibition guides', eventId: events[5]._id, organizerId: organizers[0]._id, roles: ['Guide'], requiredSkills: ['Communication', 'Art Knowledge'], dateStart: new Date('2024-07-12T18:00:00'), dateEnd: new Date('2024-07-12T22:00:00'), location: { city: 'Manhattan', state: 'NY' }, payPerPerson: 26, totalPositions: 8, positionsFilled: 6, status: 'open' },
      ...
      { title: 'Runway Assistants', description: 'Fashion show support', eventId: events[8]._id, organizerId: organizers[3]._id, roles: ['Assistant'], requiredSkills: ['Fashion', 'Time Management'], dateStart: new Date('2024-10-05T14:00:00'), dateEnd: new Date('2024-10-08T22:00:00'), location: { city: 'Manhattan', state: 'NY' }, payPerPerson: 35, totalPositions: 10, positionsFilled: 8, status: 'open' },
      ...
      { title: 'Coat Check Staff', description: 'Coat check service', eventId: events[2]._id, organizerId: organizers[2]._id, roles: ['Service'], requiredSkills: ['Customer Service'], dateStart: new Date('2024-04-10T17:00:00'), dateEnd: new Date('2024-04-10T23:00:00'), location: { city: 'Manhattan', state: 'NY' }, payPerPerson: 20, totalPositions: 4, positionsFilled: 4, status: 'filled' },
      { title: 'Cleanup Crew', description: 'Post-event cleanup', eventId: events[3]._id, organizerId: organizers[3]._id, roles: ['Cleanup'], requiredSkills: ['Physical Fitness'], dateStart: new Date('2024-05-07T18:00:00'), dateEnd: new Date('2024-05-07T22:00:00'), location: { city: 'Brooklyn', state: 'NY' }, payPerPerson: 22, totalPositions: 20, positionsFilled: 15, status: 'open' },
      { title: 'Medical Support', description: 'First aid stations', eventId: events[4]._id, organizerId: organizers[4]._id, roles: ['Medical'], requiredSkills: ['First Aid', 'Emergency Response'], dateStart: new Date('2024-09-15T06:00:00'), dateEnd: new Date('2024-09-15T14:00:00'), location: { city: 'New York', state: 'NY' }, payPerPerson: 45, totalPositions: 10, positionsFilled: 10, status: 'filled' },
      { title: 'Photography Assistants', description: 'Event photography support', eventId: events[5]._id, organizerId: organizers[0]._id, roles: ['Photography'], requiredSkills: ['Photography', 'Technical Support'], dateStart: new Date('2024-07-12T17:00:00'), dateEnd: new Date('2024-07-12T23:00:00'), location: { city: 'Manhattan', state: 'NY' }, payPerPerson: 38, totalPositions: 3, positionsFilled: 3, status: 'filled' },
      { title: 'Registration Desk', description: 'Conference registration', eventId: events[6]._id, organizerId: organizers[1]._id, roles: ['Registration'], requiredSkills: ['Communication', 'Computer Skills'], dateStart: new Date('2024-08-20T07:00:00'), dateEnd: new Date('2024-08-22T18:00:00'), location: { city: 'New York', state: 'NY' }, payPerPerson: 27, totalPositions: 10, positionsFilled: 8, status: 'open' },
